...
import { User } from '../../models/user.model'; // import the User class that makes up the form
...
export class UserService extends BaseService{
  ...
  constructor(
    public af: AngularFire, // injects the angular fire to be able to mess with the real time
   ...
   @Inject(FirebaseApp) public firebaseApp: any,  // firebaseApp is of type any but the type of the instance is to look for dependency of the FirebaseApp
    public http: Http,
  ) {
  ...
  userExists (username: string): Observable <boolean> {
    ...
           query: {
             orderByChild: 'username', // sort by 'username' attribute of each node
